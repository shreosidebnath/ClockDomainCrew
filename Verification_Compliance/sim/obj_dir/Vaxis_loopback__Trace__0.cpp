...
void Vaxis_loopback___024root__trace_chg_0_sub_0(Vaxis_loopback___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->chgQData(oldp+14,(vlSelf->axis_loopback__DOT__unnamedblk1__DOT__recv_data),64);
    bufp->chgIData(oldp+16,(vlSelf->axis_loopback__DOT__unnamedblk1__DOT__recv_len),32);
}
