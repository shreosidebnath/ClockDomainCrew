...
class Xgmii2AxisTest extends AnyFlatSpec with Matchers with ChiselScalatestTester { // TX xgmii test
  ...
  def main(configName: String, p: Xgmii2axisParams): Unit = {
    ...
    behavior of s"xgmii2axis - xgmii TX directed tests (config: $configName)"
