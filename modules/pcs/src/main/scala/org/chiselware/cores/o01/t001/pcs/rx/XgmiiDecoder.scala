...
/** 64b/66b to XGMII Protocol Decoder
  *
  * Reverses the 64b/66b encoding process. It identifies the 1-byte Block Type Field
  * and expands the compressed 7-bit control codes back into 8-bit XGMII characters.
  *
  * @constructor create a new 64b/66b decoder
  * @param dataW data width (32 or 64)
  * @param ctrlW control width (typically 8 for 64-bit data)
