...
class PcsBlackBox extends BlackBox with HasBlackBoxResource {
  ...
  addResource("org/chiselware/cores/o01/t001/pcs/taxi_eth_phy_10g_rx_ber_mon.sv")
  addResource("/org/chiselware/cores/o01/t001/pcs/taxi_eth_phy_10g_rx_frame_sync.sv")
  addResource("/org/chiselware/cores/o01/t001/pcs/taxi_eth_phy_10g_rx_if.sv")
  addResource("/org/chiselware/cores/o01/t001/pcs/taxi_eth_phy_10g_rx_watchdog.sv")
