#include "VDualWrapperNfMac10g.h"
#include "verilated.h"

#define TOP_CLASS VDualWrapperNfMac10g
...
#endif
#if VM_COVERAGE
  VerilatedCov::write(R"(/mnt/c/Users/saaed/OneDrive/Desktop/Capstone/ClockDomainCrew/test_run_dir/should_match_Chisel_vs_original_Verilog_outputs/coverage.dat)");
#endif
  top->final();
  // TODO: re-enable!
  // delete top;
...
struct sim_state {
  ...
  inline void poke(int32_t id, int64_t value) {
    ...
    switch(id) {
      ...
      case 1 : dut->io_tx_axis_tdata = u; break;
      case 2 : dut->io_tx_axis_tvalid = u; break;
      case 3 : dut->io_tx_axis_tkeep = u; break;
      case 4 : dut->io_tx_axis_tlast = u; break;
      case 5 : dut->io_tx_axis_tuser = u; break;
  ...
  inline int64_t peek(int32_t id) {
    ...
    switch(id) {
      ...
      case 1 : value = dut->io_tx_axis_tdata; break;
      case 2 : value = dut->io_tx_axis_tvalid; break;
      case 3 : value = dut->io_tx_axis_tkeep; break;
      case 4 : value = dut->io_tx_axis_tlast; break;
      case 5 : value = dut->io_tx_axis_tuser; break;
      case 6 : value = dut->io_rx_axis_tdata_chisel; break;
      case 7 : value = dut->io_rx_axis_tdata_verilog; break;
...
static sim_state* create_sim_state() {
  ...
  std::string dumpfile = R"(/mnt/c/Users/saaed/OneDrive/Desktop/Capstone/ClockDomainCrew/test_run_dir/should_match_Chisel_vs_original_Verilog_outputs/DualWrapperNfMac10g.vcd)";
